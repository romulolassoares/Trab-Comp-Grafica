...
var lightPosition = new THREE.Vector3(2.5, 1.8, 0.0);
  ...
  var stone  = textureLoader.load('../trabalho3/assets/textures/10.png');
  var sun = textureLoader.load('../trabalho3/assets/sun.jpg');
...
p.rotateY(degreesToRadians(90));
p.material.map = stone;
scene.add(p);
