...
const afterLoadPlane = (object, planeClass, playVector, planeHolder, scene) => {
...
// loadGtlfsObjects(loader, obj, tecoTecoObj, tieFifhterObj, alienPurpleObj, toonTankObj, playVector, planeClass, scene, planeHolder);

function loadPlaneGTLF(loader, planeClass, playVector, planeHolder, scene) {
   loader.load('./assets/Airplane.glb', function (gltf) {
       ...
       afterLoadPlane(obj, planeClass, playVector, planeHolder, scene);
   }, onProgress, null);
}

function loadToonTankObj(loader, toonTankObj, playVector) {
