...
loadGLTFFile('./assets/', 'Airplane', true, 2.0);
loadGLTFFile('./assets/', 'ToonTank', false, 2.0);
loadGLTFFile('./assets/', 'TecoTeco', false, 2.0);
loadGLTFFile('./assets/', 'tieFighter', false, 2.0);
loadGLTFFile('./assets/', 'AlienPurple', false, 2.0);
...
function loadGLTFFile(modelPath, modelName, visibility, desiredScale)
{
  ...
  loader.load( modelPath + modelName + '.glb', function ( gltf ) {
    ...
    if(modelName == "AlienPurple")
      obj.children.splice(5,1);
